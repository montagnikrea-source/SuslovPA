...
echo "  • POST https://montagnikrea-source.github.io/SuslovPA/api/telegram"
echo "  • GET  https://montagnikrea-source.github.io/SuslovPA/api/telegram-updates"
echo "  • POST https://montagnikrea-source.github.io/SuslovPA/api/telegram-secure"
...
echo "  curl -X POST https://montagnikrea-source.github.io/SuslovPA/api/telegram \\"
